...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-34908-book-thickness-of-subdivisions-e4d13c3c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-34908"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-34908-book-thickness-of-subdivisions-e4d13c3c-v1",
      "problem_contract_sha256": "a502d35554d8ea0b9a0e4ab867814ff402ba38b9d64a68a07c1e9f817843e6b1",
      "problem_id": "problem:um-opg-34908-book-thickness-of-subdivisions-e4d13c3c",
      "route_id": "route:um-opg-34908-book-thickness-of-subdivisions-e4d13c3c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-34908-book-thickness-of-subdivisions-e4d13c3c-source-fidelity-01",
      "graph_id": "graph:um-opg-34908-book-thickness-of-subdivisions-e4d13c3c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-34908-book-thickness-of-subdivisions-e4d13c3c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-34908-book-thickness-of-subdivisions-e4d13c3c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $G$ be a finite undirected simple graph. A $k$-page book embedding of $G$ consists of a linear order $\\preceq$ of $V(G)$ and a (non-proper) $k$-colouring of $E(G)$ such that edges with the same colour do not cross with respect to $\\preceq$. That is, if $v\\prec x\\prec w\\prec y$ for some edges $vw,xy\\in E(G)$, then $vw$ and $xy$ receive distinct colours. One can think that the vertices are placed along the spine of a book, and the edges are drawn without crossings on the pages of the book. The book thickness of $G$, denoted by bt $(G)$ is the minimum integer $k$ for which there is a $k$-page book embedding of $G$. Let $G'$ be the graph obtained by subdividing each edge of $G$ exactly once. Conjecture There is a function $f$ such that for every graph $G$, $$\\text{bt}(G) \\leq f( \\text{bt}(G') )\\enspace.$$"
          },
          "statement_sha256": "2e4d452f1a1a3f099f9298db75909dc3ef8c3265e38840666f9fc87498cde8c1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-34908-book-thickness-of-subdivisions-e4d13c3c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-34908-book-thickness-of-subdivisions-e4d13c3c-root",
      "route_id": "route:um-opg-34908-book-thickness-of-subdivisions-e4d13c3c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-34908-1b59b3a704e0",
        "url": "https://www.unsolvedmath.com/problems/OPG-34908"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
